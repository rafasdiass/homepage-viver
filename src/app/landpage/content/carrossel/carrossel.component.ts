  ...
  items: CarouselItem[] = [
    {
      ...
      title: 'Banner 1',
      type: 'image',
      src: '/assets/imagens/pet-embu.png',
    },
    {
      id: 2,
      title: 'Item 2',
      type: 'image',
      src: '/assets/imagens/churrasqueira-embu.png',
    },
    { id: 3, 
      title: 'Item 3', 
      type: 'image', 
      src: '/assets/imagens/portaria-bosque.png' },
    
    {
      id: 4,
      title: 'Banner 2',
      type: 'image',
      src: '/assets/imagens/piscina-embu.png',
    },
    {
      id: 5,
      title: 'Banner 3',
      type: 'image',
      src: '/assets/imagens/praca-embu.png',
    },
    {
      id: 6,
      title: 'Banner 4',
      type: 'image',
      src: '/assets/imagens/churrasqueira-bosque.png',
    },
    {
      id: 7,
      title: 'Banner 5',
      type: 'image',
      src: '/assets/imagens/pergolado-bosque.png',
    },
    {
      id: 8,
      title: 'Banner 6',
      type: 'image',
      src: '/assets/imagens/piscina-bosque.png',
    },
  ];
